...
public class JSONHelper {  
     ...
     * @param value 
     */  
    public static void setFieldValue(Object obj,Field field,String fieldType,Object value){  
        ...
        try {  
            if (isArray(clazz)) { // 数组  
                ...
                if (!isNull(ja)) {  
                    ...
                    setFieldValue(obj, field, clazz.getSimpleName(), array);
                }  
                ...
                if (!isNull(ja)) {  
                    ...
                    setFieldValue(obj, field, clazz.getSimpleName(), o);
                }  

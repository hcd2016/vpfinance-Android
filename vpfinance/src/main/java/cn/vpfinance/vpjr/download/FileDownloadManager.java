...
public class FileDownloadManager {
    ...
    public long startDownload(String uri, String title, String description) {
        ...
        //第三种 自定义文件路径
        //req.setDestinationUri(Uri.parse(context.getExternalFilesDir("update.apk")+""));
//        Log.d("aa", "path: "+context.getExternalFilesDir("update.apk")+"");
    ...
    public Uri getDownloadUri(long downloadId) {
        ...
        if (!TextUtils.isEmpty(getDownloadPath(downloadId))) {
            return Uri.parse(getDownloadPath(downloadId));
        } else {
            return null;
        }
    }

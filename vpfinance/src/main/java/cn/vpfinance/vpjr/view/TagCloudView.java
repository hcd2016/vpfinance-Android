...
public class TagCloudView extends ViewGroup{
    ...
    private static final int     DEFAULT_RIGHT_IMAGE      = R.drawable.selector_flow_menu_switch;
    ...
    public TagCloudView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        clickIsRed = a.getBoolean(R.styleable.TagCloudView_tcvClickIsRed,true);
...
//            imageView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
            imageView.setLayoutParams(new LayoutParams(Utils.dip2px(mContext, 20), Utils.dip2px(mContext,20)));
...
//        Logger.e("getSingleTotalHeight");
        ...
        l = sizeWidth - imageWidth - mViewBorder - 20;
        t = (totalHeight - imageHeight) / 2;
        r = sizeWidth - mViewBorder - 20;
        b = (totalHeight - imageHeight) / 2 + imageHeight;
    ...
    public void setTags(List<String> tagList) {
        ...
        if (tags != null && tags.size() > 0) {
            for (int i = 0; i < tags.size(); i++) {
                ...
                if (mCurrentTag == i && clickIsRed){ //点击选中的字体换颜色
                    tagView.setTextColor(getResources().getColor(R.color.red_top));
                }else{
                    tagView.setTextColor(mTagColor);
                }

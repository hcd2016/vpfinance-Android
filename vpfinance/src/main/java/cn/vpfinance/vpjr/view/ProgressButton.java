...
public class ProgressButton extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.backgroundColor = typedArray.getInteger(R.styleable.ProgressButton_backgroundPB, Color.parseColor("#cccccc"));
        this.foreground = typedArray.getInteger(R.styleable.ProgressButton_foregroundPB,  Color.parseColor("#e02028"));
        this.textColor = typedArray.getInteger(R.styleable.ProgressButton_textcolorPB, Color.WHITE);
        this.max = typedArray.getInteger(R.styleable.ProgressButton_maxPB, 100);
        this.progress = typedArray.getInteger(R.styleable.ProgressButton_progressPB, 0);
        this.text = typedArray.getString(R.styleable.ProgressButton_textPB);
        this.textSize = typedArray.getDimension(R.styleable.ProgressButton_textSizePB, 20);
        typedArray.recycle();
    }

...
/**
 */
public class PresellTicketTabFragment extends BaseFragment implements AbsListView.OnScrollListener {
    ...
    public static PresellTicketTabFragment newInstance(int pageNum, String type) {
        PresellTicketTabFragment fragment = new PresellTicketTabFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mHttpService.getPresellTicketlistTab(mPageNum + "", mType);
        ...
        mRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                mHttpService.getPresellTicketlistTab(1 + "", mType);
            }
        });
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(getActivity(), R.layout.item_presell_ticket, null);
...
//                holder.voucher_money = (TextView) convertView.findViewById(R.id.voucher_money);
            ...
            if (datas != null && datas.size() != 0) {
                if ("1".equals(mType)) {
//                    holder.voucher_bg.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_presell_usable));
                    holder.voucherState.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_presell_header_usable));
                    holder.checkBox.setVisibility(View.GONE);
                } else if ("2".equals(mType)) {
//                    holder.voucher_bg.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_presell_nousable));
                    holder.voucherState.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_presell_header_nousable));
                    holder.checkBox.setVisibility(View.GONE);
...
//                    holder.voucher_bg.setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_presell_nousable));
                ...
                try{
//                    double v = Double.valueOf(bean.getValue());
                ...
                if (useRemarks != null){
                    try{
                        if (!TextUtils.isEmpty(useRemarks.get(0))){
                            holder.addrate_info2.setText(useRemarks.get(0));
                            holder.point2.setVisibility(View.VISIBLE);
                        }
                        if (!TextUtils.isEmpty(useRemarks.get(1))){
                            holder.addrate_info1.setText(useRemarks.get(1));

...
public class RegularProductDetailFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContentView = inflater.inflate(R.layout.pager_regular_product_detail, null);
        ...
        //        mContentView.findViewById(R.id.use_voucher_textview).setOnClickListener(new View.OnClickListener() {
        //            @Override
        //            public void onClick(View v) {
        //                mUseVoucherCheckBox.setChecked(!mUseVoucherCheckBox.isChecked());
        //            }
        //        });
        ...
        //tvStartBuy = ((TextView) mContentView.findViewById(R.id.tvStartBuy));

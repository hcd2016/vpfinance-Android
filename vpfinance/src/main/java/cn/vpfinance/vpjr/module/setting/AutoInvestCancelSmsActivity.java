...
public class AutoInvestCancelSmsActivity extends BaseActivity {
    ...
    public static void goThis(Context context) {
        Intent intent = new Intent(context, AutoInvestCancelSmsActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auto_invest_cancel_sms);
    ...
    public void onHttpSuccess(int reqId, JSONObject json) {
        ...
        if (reqId == ServiceCmd.CmdId.CMD_HX_SEND_SMS.ordinal()){
            ...
            if ("success".equals(result)){
                AutoInvestCancelSuccessActivity.goThis(AutoInvestCancelSmsActivity.this);
                finish();
            }else{

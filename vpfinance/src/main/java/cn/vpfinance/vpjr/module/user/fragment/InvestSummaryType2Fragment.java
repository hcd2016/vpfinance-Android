...
/**
 */
public class InvestSummaryType2Fragment extends BaseFragment implements OnChartValueSelectedListener {

    @Bind(R.id.useMoney)
    TextView mUseMoney;
    @Bind(R.id.waitMoney)
    TextView mWaitMoney;
    @Bind(R.id.freezeMoney)
...
//    private ArrayList<Pair<String, Float>> toastValues = new ArrayList<>();
    ...
    private InvestSummaryTab2Bean mInfo;
    ...
    public static InvestSummaryType2Fragment newInstance(int account) {
        InvestSummaryType2Fragment fragment = new InvestSummaryType2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = View.inflate(mContext, R.layout.fragment_invest_summary_type2, null);
        ...
        mHttpService.getAssetStatistics(accountType);
...
//        lineChart.setBackgroundColor(color);// 设置背景
    ...
    public void onHttpSuccess(int reqId, JSONObject json) {
        ...
        if (reqId == ServiceCmd.CmdId.CMD_AssetStatistics.ordinal()) {
            mInfo = mHttpService.onGetAssetStatistics(json);
            mTotalMoney.setText(mInfo.getTotalMoney() == 0 ? "0.00" : ("" + mInfo.getTotalMoney()));
            mFreezeMoney.setText(mInfo.getFrozenMoney() == 0 ? "¥0.00" : ("¥" + mInfo.getFrozenMoney()));
            mWaitMoney.setText(mInfo.getReturnMoney() == 0 ? "¥0.00" : ("¥" + mInfo.getReturnMoney()));
            mUseMoney.setText(mInfo.getCashMoney() == 0 ? "¥0.00" : ("¥" + mInfo.getCashMoney()));
            setData(mInfo);
//            initLineChart(mLinechart, getLineData(), Color.parseColor("#444444"));
        }
    }

    private void setData(InvestSummaryTab2Bean info) {
        // add data
    ...
    private LineData getLineData(InvestSummaryTab2Bean info) {

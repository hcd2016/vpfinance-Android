...
public class RecordDetailBean {
    ...
    /**
     * protocolList : [{"title":"出借服务协议","url":"/loaninfo/loan_protocol_2?rid=47392"},{"title":"债权转让及回购协议","url":"/loaninfo/loan_protocol_carloan?rid=47392&loanId=971"}]
     * voucherMoney : 0.00
     * loanType : 定期
    ...
    public int loanTypeNum;//1定期 2债权转让 3权益出借
    public int recordId;

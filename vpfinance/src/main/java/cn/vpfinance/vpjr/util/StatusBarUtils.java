...
//      window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
    ...
    /**
     * 修改状态栏为全透明,4.4布丁上,5.1以上顶上,不单独使用
     *
     * @param activity
     */
    @TargetApi(19)
     ...
     *
     * @param activity
     * @param cleanStatusGrayBg 是否去除7.0以上状态栏蒙灰
     */
    public static void hideStatusBar(Activity activity, boolean cleanStatusGrayBg) {
...
//            activity.getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        ...
        if (cleanStatusGrayBg) {
            cleanStatusGrayBg(activity);
        }
    }

    /**
     * 7.0以上去除蒙灰状态栏背景,底色鲜明时使用?
     *
     * @param activity
     */
    public static void cleanStatusGrayBg(Activity activity) {
    ...
    /**
     * 设置状态栏模式(文字颜色黑色或白色)       设置状态栏颜色并设置字体颜色,true为黑色false为白色
     *
     * @param activity
    ...
    /**
     * 设置MIUI系统状态栏的文字图标颜色（MIUIV6以上）.小米
     *
     * @param activity
     * @param isDark   状态栏文字及图标是否为深色
     * @return

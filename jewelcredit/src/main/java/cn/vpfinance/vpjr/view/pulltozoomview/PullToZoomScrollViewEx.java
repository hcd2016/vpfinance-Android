package cn.vpfinance.vpjr.view.pulltozoomview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<NestedScrollView> {
    ...
    private onScrollerValueListener mScrollerValueListener = null;

    public interface onScrollerValueListener{
        void onScrollerValue(int left, int top, int oldLeft, int oldTop);
    }

    public void setOnScrollerValueListener(onScrollerValueListener listener){
        mScrollerValueListener = listener;
    }
    ...
    public PullToZoomScrollViewEx(Context context, AttributeSet attrs) {
        ...
        ((InternalScrollView) mRootView).setOnScrollViewChangedListener(new OnScrollViewChangedListener() {
            ...
            public void onInternalScrollChanged(int left, int top, int oldLeft, int oldTop) {
                ...
                if (mScrollerValueListener != null){
                    mScrollerValueListener.onScrollerValue(left,top,oldLeft,oldTop);
                }
            }
        });
    }
    ...
    protected NestedScrollView createRootView(Context context, AttributeSet attrs) {
        NestedScrollView scrollView = new InternalScrollView(context, attrs);
